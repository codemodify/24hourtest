...
func (c *helloWorldServiceClient) HelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldReply, error) {
	out := new(HelloWorldReply)
	err := c.cc.Invoke(ctx, "/contracts.HelloWorldService/HelloWorld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloWorldServiceServer) HelloWorld(context.Context, *HelloWorldRequest) (*HelloWorldReply, error) {
...
func _HelloWorldService_HelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/contracts.HelloWorldService/HelloWorld",
	}
...
var HelloWorldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "contracts.HelloWorldService",
